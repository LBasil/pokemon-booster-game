...
export const MODE_ROUTES = {
  unlimited: { hub: 'game', boosters: 'boosters', collection: 'collection', binder: 'binder' },
  challenge: { hub: 'challenge', boosters: 'challenge-boosters', collection: 'challenge-collection', binder: 'challenge-binder' },
}
